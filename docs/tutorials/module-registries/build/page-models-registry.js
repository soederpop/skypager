(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["SkypagerTutorialsModuleRegistries"] = factory();
	else
		root["SkypagerTutorialsModuleRegistries"] = factory();
...
(function() { module.exports = global["lodash"]; }());
...
exports.RequireContext = exports.create = exports.default = exports.ContextRegistry = void 0;
...
var _directory = _interopRequireDefault(__webpack_require__(78));

var _lodash = _interopRequireDefault(__webpack_require__(2));

var _keys = _lodash.default.keys,
    has = _lodash.default.has,
    result = _lodash.default.result;
...
/*#__PURE__*/
function (_Directory) {
  (0, _inherits2.default)(ContextRegistry, _Directory);

  function ContextRegistry(name) {
    var _this;

    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    (0, _classCallCheck2.default)(this, ContextRegistry);
    ...
    var webpackContext = options.context || options.req || createMockContext();
    delete options.context;
    delete options.req;
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ContextRegistry).call(this, name, options));
    hide((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), 'context', _this.wrapContext(webpackContext, Object.assign({}, options, {
  ...
  (0, _createClass2.default)(ContextRegistry, [{
    key: "isValidContext",
    ...
    value: function add(webpackContext) {
      ...
      this.registerContextModules(this.wrapContext(webpackContext, Object.assign({}, this.options, options)));
    }
  }, {
...
function () {
  ...
  function RequireContext(webpackRequireContext) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    (0, _classCallCheck2.default)(this, RequireContext);
  ...
  (0, _createClass2.default)(RequireContext, [{
    key: "metaForKey",
    ...
    get: function get() {
      ...
      return this.keys.reduce(function (memo, key) {
        var id = "".concat(key.replace(/^\.\//, _this3.namespace).replace(_this3.prefix, '').replace(/\.\w+$/, ''));
        return Object.assign(memo, (0, _defineProperty2.default)({}, id, key));
      }, {});
    }
  }]);
...
exports.mixinPropertyUtils = mixinPropertyUtils;
exports.enhanceObject = enhanceObject;
exports.createInterface = createInterface;
exports.applyInterface = applyInterface;
exports.mixinLodashMethods = mixinLodashMethods;
exports.hideProperties = hideProperties;
exports.hideGetter = hideGetter;
exports.getter = getter;
exports.hideProperty = hideProperty;
exports.lazy = lazy;
exports.hashObject = exports.createEntity = exports.hide = exports.transformKey = void 0;

var _typeof2 = _interopRequireDefault(__webpack_require__(7));

var _objectSpread2 = _interopRequireDefault(__webpack_require__(4));
...
function propertyUtils(target) {
  return {
    lazy: (0, _lodash.partial)(lazy, target),
    hide: (0, _lodash.partial)(hideProperty, target),
    hideProperty: (0, _lodash.partial)(hideProperty, target),
    hideGetter: (0, _lodash.partial)(hideGetter, target),
    hideProperties: (0, _lodash.partial)(hideProperties, target),
    getter: (0, _lodash.partial)(getter, target),
    applyInterface: (0, _lodash.partial)(applyInterface, target)
  };
}
...
function createCollection() {
  ...
  host.lazy('models', function () {
    return mixinPropertyUtils(((0, _lodash.isFunction)(items) ? items.call(host) : items) || [], true);
  });
  return host;
}
...
function enhanceObject(target, options) {
  ...
  (0, _lodash.mapValues)(propUtils, function (fn, name) {
  ...
  var _options = options,
      ...
      includeLodashMethods = _options$includeLodas === void 0 ? (0, _lodash.isFunction)(lodash) : _options$includeLodas,
      _options$includeChain = _options.includeChain,
      includeChain = _options$includeChain === void 0 ? (0, _lodash.isFunction)(lodash) && (0, _lodash.isFunction)(lodash.chain) : _options$includeChain;

  if (includeLodashMethods) {
    if ((0, _lodash.isObject)(target) && !(0, _lodash.isArray)(target)) {
      objectMethods.filter(function (name) {
        return lodash[name];
      }).forEach(function (name) {
        return hideProperty(target, name, (0, _lodash.partial)(lodash[name], target));
      });
    } else if ((0, _lodash.isArray)(target)) {
  ...
  if (includeChain && !(0, _lodash.has)(target, 'chain') && (0, _lodash.isFunction)(lodash.chain)) {
    hideGetter(target, 'chain', (0, _lodash.partial)(lodash.chain, target));
  }
...
var transformKey = function transformKey(key) {
  return (0, _lodash.lowerFirst)((0, _lodash.camelCase)(key.replace(new RegExp("^(get|lazy)", ''), '')));
};
...
function createInterface() {
  ...
  var interFace = (0, _lodash.mapValues)((0, _lodash.pickBy)(interfaceMethods, _lodash.isFunction), function (prop, propName) {
    return function () {
      ...
      if (partial.length > 0 && right === false) {
        args = (0, _toConsumableArray2.default)(partial).concat((0, _toConsumableArray2.default)(args));
      }
      ...
      if (right === true && partial.length > 0) {
        ...
        (_args = args).push.apply(_args, (0, _toConsumableArray2.default)(partial));
      }

      return prop.call.apply(prop, [scope].concat((0, _toConsumableArray2.default)(args)));
    };
  });
...
function applyInterface(target) {
  ...
  var i = methods.isInterface ? methods : createInterface(methods, (0, _objectSpread2.default)({
    scope: scope,
    transformKeys: transformKeys,
    safe: safe,
    hidden: hidden
  }, options));
  (0, _lodash.mapValues)(i, function (method, propName) {
...
function mixinLodashMethods(target) {
  ...
  Object.keys(l).forEach(function (method) {
    return hideProperty(target, method, (0, _lodash.partial)(l[method], target));
  });
  return target;
}
/**
...
function hideGetter(target, name, fn) {
  ...
  if (typeof fn === 'function') {
    fn = _lodash.partial.apply(void 0, [fn].concat((0, _toConsumableArray2.default)(options.args || [])));
  }

  defineProperty(target, name, (0, _objectSpread2.default)({
    enumerable: false
  }, options, {
    get: function get() {
...
function getter(target, name, fn) {
  var options = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : {};
  return hideGetter(target, name, fn, (0, _objectSpread2.default)({}, options, {
    enumerable: true
  }));
}
...
function hideProperty(target, name, value) {
  ...
  defineProperty(target, name, (0, _objectSpread2.default)({}, options, {
    enumerable: false,
    value: value
  }));
  return target;
...
var createEntity = function createEntity() {
  ...
  return mixinPropertyUtils.apply(void 0, [(0, _lodash.cloneDeep)(object)].concat(args));
};

exports.createEntity = createEntity;

var hashObject = __webpack_require__(84);
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "pageSelectors", function() { return pageSelectors; });
var title = 'Home';
var path = '/';
var pageSelectors = {
  main: '#home-page'
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(title, "title", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/HomePage.js");

  __REACT_HOT_LOADER__.register(path, "path", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/HomePage.js");

  __REACT_HOT_LOADER__.register(pageSelectors, "pageSelectors", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/HomePage.js");
}();
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(title, "title", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/AboutPage.js");

  __REACT_HOT_LOADER__.register(path, "path", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/AboutPage.js");

  __REACT_HOT_LOADER__.register(pageSelectors, "pageSelectors", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/pages/AboutPage.js");
}();
...
module.exports = global["lodash"] = __webpack_require__(30);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__page_models__ = __webpack_require__(32);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_HomePage__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__pages_AboutPage__ = __webpack_require__(27);



__WEBPACK_IMPORTED_MODULE_0__page_models__["a" /* pageModels */].register('HomePage', function () {
  return __WEBPACK_IMPORTED_MODULE_1__pages_HomePage__;
});
__WEBPACK_IMPORTED_MODULE_0__page_models__["a" /* pageModels */].register('AboutPage', function () {
  return __WEBPACK_IMPORTED_MODULE_2__pages_AboutPage__;
});
console.log('Available Pages');
console.log(__WEBPACK_IMPORTED_MODULE_0__page_models__["a" /* pageModels */].available);
var aboutPage = __WEBPACK_IMPORTED_MODULE_0__page_models__["a" /* pageModels */].lookup('AboutPage');
console.log("About Page Path: ".concat(aboutPage.route));
;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(aboutPage, "aboutPage", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/index.js");
}();
...
"use strict";
/* unused harmony export PageModels */
/* unused harmony export PageModel */
/* unused harmony export pageModelsApi */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return pageModels; });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_slicedToArray__ = __webpack_require__(16);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator__ = __webpack_require__(36);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__babel_runtime_helpers_asyncToGenerator__ = __webpack_require__(39);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__babel_runtime_helpers_createClass__ = __webpack_require__(6);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_5__babel_runtime_helpers_possibleConstructorReturn__ = __webpack_require__(10);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__babel_runtime_helpers_inherits__ = __webpack_require__(13);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_entries__ = __webpack_require__(41);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8_lodash_entries___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_8_lodash_entries__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__skypager_runtime_lib_registries_context__ = __webpack_require__(23);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__skypager_runtime_lib_registries_context___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_9__skypager_runtime_lib_registries_context__);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__pages_HomePage__ = __webpack_require__(26);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__pages_AboutPage__ = __webpack_require__(27);
...
var PageModels =
/*#__PURE__*/
function (_ContextRegistry) {
  __WEBPACK_IMPORTED_MODULE_7__babel_runtime_helpers_inherits___default()(PageModels, _ContextRegistry);

  /**
   * @param {String} name - the name of the registry
   * @param {RegistryOptions} options - registry options
   */
  function PageModels(name) {
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};

    __WEBPACK_IMPORTED_MODULE_3__babel_runtime_helpers_classCallCheck___default()(this, PageModels);

    return __WEBPACK_IMPORTED_MODULE_5__babel_runtime_helpers_possibleConstructorReturn___default()(this, __WEBPACK_IMPORTED_MODULE_6__babel_runtime_helpers_getPrototypeOf___default()(PageModels).call(this, name, options));
  }

  __WEBPACK_IMPORTED_MODULE_4__babel_runtime_helpers_createClass___default()(PageModels, [{
    key: "discover",
    value: function () {
      var _discover = __WEBPACK_IMPORTED_MODULE_2__babel_runtime_helpers_asyncToGenerator___default()(
      /*#__PURE__*/
        ...
        return __WEBPACK_IMPORTED_MODULE_1__babel_runtime_regenerator___default.a.wrap(function _callee$(_context) {
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                return _context.abrupt("return", 'discovering');
  ...
  return PageModels;
}(__WEBPACK_IMPORTED_MODULE_9__skypager_runtime_lib_registries_context___default.a);
/**
 * @name PageModel
 */
...
function () {
  ...
  function PageModel(options) {
    __WEBPACK_IMPORTED_MODULE_3__babel_runtime_helpers_classCallCheck___default()(this, PageModel);
  ...
  __WEBPACK_IMPORTED_MODULE_4__babel_runtime_helpers_createClass___default()(PageModel, [{
    key: "route",
    get: function get() {
    ...
    get: function get() {
      ...
      var _provider$pageSelecto = provider.pageSelectors,
          pageSelectors = _provider$pageSelecto === void 0 ? {} : _provider$pageSelecto;
...
var pageModelsApi = {
  findByRoute: function findByRoute(route) {
    return __WEBPACK_IMPORTED_MODULE_8_lodash_entries___default()(this.allMembers()).filter(function (_ref) {
      var _ref2 = __WEBPACK_IMPORTED_MODULE_0__babel_runtime_helpers_slicedToArray___default()(_ref, 2),
          id = _ref2[0],
          pageModel = _ref2[1];

      return pageModel.route === route;
    });
  }
};
var pageModels = new PageModels('pageModels', {
  ...
  context: Object(__WEBPACK_IMPORTED_MODULE_9__skypager_runtime_lib_registries_context__["createMockContext"])(),
  api: pageModelsApi
});
pageModels.register('HomePage', function () {
  return __WEBPACK_IMPORTED_MODULE_10__pages_HomePage__;
});
pageModels.register('AboutPage', function () {
  return __WEBPACK_IMPORTED_MODULE_11__pages_AboutPage__;
});
;
...
var _temp = function () {
  ...
  __REACT_HOT_LOADER__.register(PageModels, "PageModels", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/page-models.js");

  __REACT_HOT_LOADER__.register(PageModel, "PageModel", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/page-models.js");

  __REACT_HOT_LOADER__.register(pageModelsApi, "pageModelsApi", "/Users/jon/Projects/@skypager/docs/tutorials/module-registries/src/examples/page-models-registry/page-models.js");
...
var createToPairs = __webpack_require__(43),
...
var baseToPairs = __webpack_require__(44),
    getTag = __webpack_require__(46),
    mapToArray = __webpack_require__(58),
    setToPairs = __webpack_require__(59);
...
exports.create = exports.default = exports.Directory = void 0;
...
var _simple = _interopRequireDefault(__webpack_require__(79));
...
function (_SimpleDirectory) {
  (0, _inherits2.default)(Directory, _SimpleDirectory);
  ...
  function Directory(name) {
    ...
    _this = (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(Directory).call(this, name, options));

    if (options.api) {
      Object.keys(options.api).forEach(function (meth) {
        _this[meth] = options.api[meth].bind((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)));
      });
    }

    if (options.lookupMethod) {
      var me = (0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this));
      Object.assign((0, _assertThisInitialized2.default)((0, _assertThisInitialized2.default)(_this)), (0, _defineProperty2.default)({}, options.lookupMethod, me.lookup.bind(me)));
    }
  ...
  (0, _createClass2.default)(Directory, [{
    ...
    value: function meta(id) {
      ...
      return this.metadata[id] = (0, _objectSpread2.default)({}, result, this.testRoute(id) || {}, updateData);
    }
  }, {
    key: "applyRoute",
    ...
    value: function register(id, fn) {
      ...
      this.metadata.register(id, function () {
        return (0, _objectSpread2.default)({}, metadata, {
          registryId: id
        }, _this2.testRoute(id) || {});
      });
      return this;
...
exports.create = exports.default = exports.SimpleRegistry = void 0;

var _defineEnumerableProperties2 = _interopRequireDefault(__webpack_require__(24));

var _slicedToArray2 = _interopRequireDefault(__webpack_require__(16));

var _objectSpread3 = _interopRequireDefault(__webpack_require__(4));
...
var _query2 = _interopRequireDefault(__webpack_require__(85));

var _registry = _interopRequireDefault(__webpack_require__(86));

var _router = _interopRequireDefault(__webpack_require__(87));

var pickBy = _lodash.default.pickBy,
    mapValues = _lodash.default.mapValues,
    isFunction = _lodash.default.isFunction,
    isObject = _lodash.default.isObject,
    has = _lodash.default.has,
    _get = _lodash.default.get,
    pick = _lodash.default.pick;

var SimpleRegistry =
/*#__PURE__*/
function () {
  (0, _createClass2.default)(SimpleRegistry, null, [{
    key: "attach",
    ...
    value: function attach(name) {
      ...
      return {
        to: function to(target) {
          (0, _registry.default)(target, name, options, cache);
  ...
  function SimpleRegistry(name) {
    ...
    var options = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var cache = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : {};
    (0, _classCallCheck2.default)(this, SimpleRegistry);
    this.name = name;
    (0, _properties.enhanceObject)(this, _lodash.default);
    hide(this, 'options', (0, _objectSpread3.default)({
      router: {}
    }, options, {
      name: name
    }));
    hide(this, 'createRouter', function () {
      ...
      return (0, _router.default)(_this, options);
    });
  ...
  (0, _createClass2.default)(SimpleRegistry, [{
    key: "query",
    value: function query() {
      var items = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
      var params = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
      return (0, _query2.default)(items, params);
    }
  }, {
    key: "add",
    ...
    value: function _register(componentId, componentFn) {
      ...
      var _this$componentWillRe = this.componentWillRegister(componentId, componentFn),
          _this$componentWillRe2 = (0, _slicedToArray2.default)(_this$componentWillRe, 2),
    ...
    value: function allMembers() {
      ...
      return this.available.reduce(function (memo, key) {
        ...
        return (0, _objectSpread3.default)({}, memo, (_objectSpread2 = {}, _mutatorMap = {}, _mutatorMap[key] = _mutatorMap[key] || {}, _mutatorMap[key].get = function () {
          return reg.lookup(key);
        }, (0, _defineEnumerableProperties2.default)(_objectSpread2, _mutatorMap), _objectSpread2));
      }, {});
    }
  }, {
...
var iterableToArray = __webpack_require__(82);

var nonIterableSpread = __webpack_require__(83);
...
exports.query = query;
exports.testWithOperator = testWithOperator;
exports.default = exports.operators = void 0;

var _lodash = __webpack_require__(2);

var isRegex = _lodash.isRegExp;
var equals = _lodash.eq;

var not_equals = function not_equals() {
  return !_lodash.eq.apply(void 0, arguments);
};
...
function query() {
  ...
  return items.filter(function (node) {
    var matchesParam = Object.keys(params).every(function (key) {
      ...
      var value = (0, _lodash.result)(node, key);
      ...
      if ((0, _lodash.isArray)(param) && ((0, _lodash.isString)(value) || (0, _lodash.isNumber)(value))) {
        return (0, _lodash.some)(param, function (val) {
          return val === value;
        });
      }

      if ((0, _lodash.isObject)(param) && (param.value || param.val) && (param.op || param.operator)) {
        return testWithOperator(param, value);
      }

      if ((0, _lodash.isObject)(param) && (0, _lodash.isObject)(value)) {
        return (0, _lodash.isMatch)(value, param);
      }
    });
...
function testWithOperator(param, testValue) {
  ...
  var testFn = operators[operator] || _lodash.isEqual;
...
function create(host, propKey) {
  ...
  if (!host[cacheKey]) {
    (0, _properties.hideProperty)(host, cacheKey, cacheObject);
  }

  var getters = {};
  var available = keys(descriptors((0, _objectSpread2.default)({}, host[cacheKey], members)));
  available.forEach(function (key) {
    ...
    }, (0, _defineEnumerableProperties2.default)(_assign, _mutatorMap), _assign));
  });
  (0, _properties.hideGetter)(host, propKey, function () {
    keys(descriptors(host[cacheKey])).forEach(function (key) {
      ...
      return assign(getters, (_assign2 = {}, _mutatorMap2 = {}, _mutatorMap2[key] = _mutatorMap2[key] || {}, _mutatorMap2[key].get = function () {
        return host[cacheKey][key];
      }, (0, _defineEnumerableProperties2.default)(_assign2, _mutatorMap2), _assign2));
    });
    return (0, _objectSpread2.default)({}, getters, {
      get available() {
        return keys(descriptors(host[cacheKey]));
      },

      get register() {
        return (0, _lodash.partial)(_properties.lazy, host[cacheKey]);
      },

      lookup: function lookup(id) {
        return (0, _lodash.get)(this, id) || (0, _lodash.get)(getters, id);
      }
    });
  });
  return host[propKey];
...
var _pathToRegexp = _interopRequireDefault(__webpack_require__(88));
...
function router(host) {
    ...
    get: function get() {
      return {
        ...
        get: function get(pattern) {
          ...
          var pathsToTest = (0, _lodash.result)(host, pathsGetter, []).map(function (item) {
            return (0, _lodash.result)(item, pathProperty);
          });
  ...
  return (0, _lodash.get)(host, options.routerProperty);
}
...
function pathMatcher() {
  ...
  return function (route) {
    var keys = [],
        reg = _pathToRegexp.default.apply(this, [route, keys, options]);
...
//# sourceMappingURL=page-models-registry.js.map